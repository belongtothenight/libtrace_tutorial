...
void check_report(libtrace_packet_t *packet) {
	struct timeval ts;
 ...
 */
uint64_t calc_meta_size(libtrace_packet_t *packet) {
 ...
 */
uint64_t calc_link_size(libtrace_packet_t *packet) {
	void *link_ptr;
	void *nexthdr;
...
uint64_t calc_ip_size(libtrace_packet_t *packet, demo_proto_t *proto) {
 ...
 * options etc. */
uint64_t calc_transport_size(libtrace_packet_t *packet) {
...
uint64_t calc_header_size(libtrace_packet_t *packet, demo_proto_t *proto) {
...
uint64_t calc_payload_size(libtrace_packet_t *packet, demo_proto_t proto) {
